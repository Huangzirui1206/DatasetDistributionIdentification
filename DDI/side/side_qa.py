...
4. If the perturbed text is highly likely to be merely user input, return the perturbed sequence directly.
...
Hi, I am having severe pain in my right leg which comes and goes sometimes when i walk for few minutes or sit still. This has been going since last 2 months. I had it once before but got better within 3 days..This time its not getting better even after taking medicines prescribed by doctors..I have tried applying ice packs to it several times but no effect...Please help me out as soon as possible so that i can take care of this problem . Thanks
</perturbed_end>
...
def generate_output(base_model:str=base_model,
                    ...
                    num_sample_texts:int = 100,
                    num_start_up_texts:int = 100,
    ...
    engine = VllmEngine(surrogate_model_path, model_type=surrogate_model_type, 
                        ...
                        gpu_memory_utilization=surrogate_surrogate_gpu_utility,
    ...
    random_idx = 0
    while len(final_texts) < num_total_outputs:
        ...
        seed_sequences = seed_sequences[:num_total_outputs-len(final_texts)]
